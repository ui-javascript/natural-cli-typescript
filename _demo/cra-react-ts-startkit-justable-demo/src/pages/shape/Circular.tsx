...
class Circular extends React.Component<{}> {
  ...
  public render() {
    ...
    return (
      <div>
        {
          circulars.map((o: ICircular, i: number) =>
            <div key={i} className={`animated bounce`} style={{display: 'inline-block', 'animationDuration': o.animateDuration, margin: o.margin, 'borderRadius': o.radius, width: o.width, height: o.height, 'backgroundColor': `rgb(${o.color})`}}/>)
        }
      </div>
    )
  }
