...
export const asynchronousComponents = {
    SocketDebugger: loadComponent(() => import(/* webpackChunkName: "socket-debugger" */ 'containers/views/SocketDebugger')),
    Users: loadComponent(() => import(/* webpackChunkName: "users" */ 'containers/views/Users'))
}
